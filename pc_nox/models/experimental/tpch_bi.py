...
class TpchControlLayer(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        key_rec, key_in, key_child_curr = jr.split(key, 3)
    ...
    def predict(self, state_prev: Array, child_curr: Array, control_input: Optional[Array] = None) -> Array:
        """s_hat_t = f(A @ s_{t-1} + B @ x_t)"""
...
class TpchHiddenLayer(eqx.Module):
    ...
    def __init__(
        ...
        *,
        ...
        key_rec, key_parent_prev, key_parent_curr, key_child_curr = jr.split(key, 4)
        self.W_rec = eqx.nn.Linear(state_size, state_size, use_bias=False, key=key_rec)
    ...
    def predict(self, state_prev: Array, parent_prev: Array, parent_curr: Array, child_curr: Array) -> Array:
        """z_hat_t = f(P @ z_{t-1} + Q @ s_{t-1} + R @ s_t)"""
        return self.act_fn(
...
class TpchModel(eqx.Module, ModelBase):
    ...
    def __init__(
        ...
        for size, child_size, hkey in zip(hidden_sizes, child_sizes, hidden_keys):
